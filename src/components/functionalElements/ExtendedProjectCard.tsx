...
export default function ExtendedProjectCard({
  project,
  index = 0,
    ...
    >
      ...
      <div className="w-full lg:w-[45%] flex flex-col text-left">
        <div className="flex items-center gap-x-4">
          ...
          <h2 className="font-bold text-[26px] sm:text-[32px] text-[#F5F5F5] text-left">
            {project.name}
          </h2>
        </div>
        ...
        <div className="flex items-center gap-x-5 mt-6">
          {project.repoLinks ? (
            <>
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-x-2 text-[#F5F5F5]/70 hover:text-[#008CFF] transition-all duration-200 hover:[filter:drop-shadow(0_0_8px_rgba(0,140,255,0.6))]"
              >
                <CodeXml size={22} />
          ...
          {project.projectLink && (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex items-center gap-x-2 px-4 py-2 bg-[#008CFF] text-[#121212] rounded-[8px] text-[13px] font-semibold transition-transform duration-200 hover:scale-[1.04] hover:shadow-[0_0_20px_rgba(0,140,255,0.4)]"
            >
              <LinkIcon size={16} />
              Live site
            </a>
